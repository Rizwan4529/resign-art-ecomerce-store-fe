...
import { Package, Truck, Clock, CheckCircle, XCircle, Edit, Search } from 'lucide-react';
...
export const OrderManagement = () => {
  ...
  // RTK Query hooks
  const { data: ordersData, isLoading } = useGetAllOrdersQuery({ page: 1, limit: 100 });
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        {order.delivery?.trackingNumber && (
                          <p className="text-sm text-gray-600">Tracking: {order.delivery.trackingNumber}</p>
                        )}
                      </div>
                    </div>
                  </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        {order.delivery?.courierCompany && (
                          <p className="text-sm">
                            <span className="font-medium">Courier:</span> {order.delivery.courierCompany}
                          </p>
                        )}
                      </div>
                    </div>
        ...
        <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
          <DialogContent className="sm:max-w-[500px]">
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="description">Status Update Description (Optional)</Label>
                <Textarea
                  id="description"
