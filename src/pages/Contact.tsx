...
export const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['hello@resinart.com', 'support@resinart.com', 'custom@resinart.com'],
  ...
  const faqs = [
    {
      ...
      answer: 'Yes! We specialize in custom resin art pieces. Contact us with your vision and we\'ll bring it to life.'
    },
    {
      question: 'What is your typical turnaround time?',
      answer: 'Standard pieces ship within 3-5 business days. Custom orders typically take 2-4 weeks depending on complexity.'
    },
    {
      question: 'Do you ship internationally?',
      answer: 'Currently we ship within the United States and Canada. International shipping is available for select items.'
    },
    {
      question: 'What materials do you use?',
      answer: 'We use only premium epoxy resin, high-quality pigments, and sustainable materials in all our creations.'
    }
  ];
      ...
      <section className="relative py-20 bg-gradient-to-r from-blue-600 to-purple-600 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Have a question, custom request, or just want to chat about resin art? We'd love to hear from you!
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              <Card key={index} className="bg-white/80 backdrop-blur-sm border-white/20 hover:shadow-lg transition-all duration-300 hover:scale-105">
            ...
            <div className="space-y-6">
              <Card className="bg-white/70 backdrop-blur-sm border-white/20">
                <CardHeader>
                  ...
                  <CardDescription>
                    Quick answers to common questions about our resin art services
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="bg-gradient-to-br from-blue-50 to-purple-50 border-blue-200">
                <CardContent className="p-6">
                  ...
                  <blockquote className="text-gray-700 italic mb-4">
                    "The team at ResinArt created the most beautiful custom piece for our living room. 
                    The communication throughout the process was excellent, and the final result exceeded 
                    our expectations!"
                  </blockquote>
              ...
              <Card className="bg-green-50 border-green-200">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-semibold text-green-800 mb-2">Quick Response Guarantee</h4>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Whether it's a custom piece or questions about our collection, we're here to help
          </p>
